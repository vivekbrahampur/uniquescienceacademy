...
const ManageTeachersTab = lazy(() => import('../components/ManageTeachersTab'));
        ...
        >
          ...
          {activeTab === 'manage_teachers' && (
            <Suspense fallback={<div>Loading...</div>}>
              <ManageTeachersTab onSuccess={() => showSuccess('Teacher operation successful')} showSuccess={showSuccess} showError={showError} />
            </Suspense>
          )}
